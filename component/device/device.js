...
var IsLicaiApp = /baidulicaiapp/i.test(UA.toLowerCase());
var IsBaiduNewsApp = /bdnews/i.test(UA.toLowerCase());


var IsNightMode = /night=1/i.test(location.href);
var IsDebug = ~("" + LOC["port"]).indexOf("0");

var IsRetina = false;
var IsHigherRetina = false;
...
var device = {
    ...
    IsDebug: IsDebug,
    IsRetina: IsRetina,
    IsHigherRetina: IsHigherRetina,
    IsQQBrowser: IsQQBrowser,
    IsLicaiApp: IsLicaiApp,
    IsBaiduNewsApp: IsBaiduNewsApp,
